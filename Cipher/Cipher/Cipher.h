...
// ============================================================
// ICipher — şifreleme stratejisi arayüzü
// ============================================================
class ICipher {
public:
    virtual ~ICipher() = default;

    // Veriyi şifrele — out buffer'ı en az len byte olmalı
    virtual BYTEV encrypt(const BYTE* data, size_t len) const = 0;

    // Şifreli veriyi çöz — out buffer'ı en az len byte olmalı
    ...
    // Backwards-compatible output-into virtuals: cipher implementasyonları optimize edebilir
