...
// Log Türleri (birbirinden bağımsız açılıp kapatılabilir)
enum class LogType {
	Error = 0,
	Warning = 1,
	Info = 2,
...
public:
	...
	// Belirli bir log türünün açık olup olmadığını kontrol et
...
private:
	...
	// Copy ve move işlemleri engelle
	...
	// UYARI: Bu fonksiyonlar zaten kilitlenmiş bağlamda çağrılmalıdır
	...
	// Member variables
	LogLevel m_logLevel{LogLevel::Info}; // Varsayılan log seviyesi başlatıldı
