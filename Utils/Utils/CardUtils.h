...
// NOTE: Namespace ad� "DESFire" -> "CardUtils" olarak de�i�tirildi.
// E�er proje genelinde "DESFire::" kullan�mlar� varsa hepsinin de g�ncellenmesi gerekir.

// ============================================================
// Kart komutlar� ve parse (DESFire'e �zg� APDU'lar kullan�lmakla birlikte
// fonksiyonlar genel kart/versiyon/UID i�lemleri sunar)
// ============================================================
