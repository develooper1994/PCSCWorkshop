...
void testACR1281UReaderUnsecured(ACR1281UReader& acr1281u) {
    std::cout << "\n--- " << __func__ << ": ---\n";
    try {
        BYTE startPage = 4;
...
void testACR1281UReaderSecured(ACR1281UReader& acr1281u) {
...
void testACR1281UReaderXorCipher(ACR1281UReader& acr1281u) {
...
void testACR1281UReaderCaesarCipher(ACR1281UReader& acr1281u) {
    CaesarCipher cipher(3);
    runPerPageTest(acr1281u, cipher, "CaesarCipher", "Caesar cipher test string");
}

#ifdef _WIN32
void testACR1281UReaderCngAES(ACR1281UReader& acr1281u) {
...
void testACR1281UReaderCng3DES(ACR1281UReader& acr1281u) {
...
void testACR1281UReaderCngAESGcm(ACR1281UReader& acr1281u) {
